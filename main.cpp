...
//    // Initialize grid using sphere of radius 1.5 as SDF
...
//                grid->operator()(x, y, z) = Length(p) - 1.5f;
//            }
//        }
//    }
//
//    // Create debug ray
//    Ray ray(Vector3F(0.f, 0.f, 10.f), Vector3F(0.f, 0.f, -1.f));
//
//    // Try to intersect ray with grid
//    Interaction interaction;
//    bool hit = grid->Intersect(ray, &interaction);
//
//    // Create scene
//    Scene scene;
//
